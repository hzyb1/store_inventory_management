				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
						...
						<s:form class="am-form am-form-horizontal"
							action="updateProduct" method="post" theme="simple">
							<div class="am-form-group">
								<label for="user-name" class="am-u-sm-3 am-form-label">
									编号 / id </label>
								<div class="am-u-sm-9">
									<s:textfield  id="user-name" required="required"
										 name="changeProduct.id" readonly="true"/>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<s:textfield  id="name" required="required"
										placeholder="商品名称" name="changeProduct.name"/>
										<small>10字以内...</small>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<s:textfield  id="name" required="required"
										placeholder="商品价格" name="changeProduct.price"/>
										<small>...</small>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<s:textfield  id="name" required="required"
										placeholder="商品名称" name="changeProduct.barcode"/>
										<small>6位数字...</small>
								</div>
							</div>
